...
# Sample input 1
print("Sample input 1: x=0 evaluated into  y = 3x3 - 2x2 + 3x - 1, results in: ")
...
print("Sample input 2: x=1 evaluated into y = 3x3 - 2x2 + 3x - 1, results in: ")
...
print("Sample input 3: x=-1 evaluated into y = 3x3 - 2x2 + 3x - 1, results in: ")
